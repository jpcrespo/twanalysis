...
def timeserie(target):
   ...
   plt.annotate('Elecciones 2019', xy=(datetime(2019, 10, 20),np.mean(cnt)),xytext=(datetime(2019, 11, 20),np.mean(cnt)+2),fontsize=13,fontproperties=prop,color=tableau20[1],
               arrowprops=dict(facecolor='red', shrink=0.05))

   plt.annotate('Elecciones 2020', xy=(datetime(2020, 10, 18),np.mean(cnt)),xytext=(datetime(2020, 11, 18),np.mean(cnt)+2),fontsize=13,fontproperties=prop,color=tableau20[1],
               arrowprops=dict(facecolor='red', shrink=0.05))
...
#guardando datos para comparaciones
   np.save('resultados/'+target+'.npy',(date,cnt))
